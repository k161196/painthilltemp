          ...
          <div className="mt-4 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 xl:gap-x-8">
            <div>
             {/* <h3 className='text-center md:text-start text-offwhite text-lg'>@2023 - All Rights Reserved by <Link href="https://adminmart.com/" target="_blank"> Adminmart.com</Link></h3>*/}
                                      <h3 className='text-white text-4xl font-semibold leading-9 text-center md:text-start'> Paint Hill</h3>

            </div>
            <div className='flex justify-center md:justify-end'>
              <div className='footer-icons mr-2'>
                <Link href="https://www.facebook.com/PaintHill"><Image src={'/images/footer/vec.svg'} alt="facebook" width={15} height={20} /></Link>
              </div>
              <div className='footer-icons mr-2'>
                <Link href="https://twitter.com/painthill"><Image src={'/images/footer/twitter.svg'} alt="twitter" width={20} height={20} /></Link>
              </div>
              <div className='footer-icons'>
                <Link href="https://instagram.com/painthill.in"><Image src={'/images/footer/instagram.svg'} alt="instagram" width={20} height={20} /></Link>
              </div>
            </div>
